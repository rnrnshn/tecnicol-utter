...
<head>
    ...
    <title>TECNICOL - Vocational Training Centre</title>
...
<body>
        ...
        <div class="container-fluid container-xxl d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#programmes">Programmes</a></li>
                    <li><a class="nav-link scrollto" href="#gallery">Gallery</a></li>
                    <li>
                        <a class="nav-link scrollto" href="#supporters">Partners</a>
                    </li>
            ...
            <!-- .navbar -->
            <a class="buy-tickets" href="index.php?lang=en"><img class="lang" src="assets/img/EN.webp" alt="">EN</a>
            <a class="buy-tickets" href="index.php?lang=pt"><img class="lang" src="assets/img/MZ.webp" alt="">PT</a>
        </div>
    </header>
    <!-- End Header -->
    ...
    <section id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            <h1 class="mb-4 pb-0">
                ...
                YOUR TRAINING & DEVELOPMENT <br /><span> PARTNER IN MOZAMBIQUE</span>
            </h1>
            <p class="mb-4 pb-0">
                TECNICOL MOÇAMBIQUE - VOCATIONAL TRAINING CENTRE
            </p>
            <!-- <a
            ...
            <div class="container position-relative" data-aos="fade-up">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <p>
                            Tecnicol Moçambique is a professional training centre with a proven track record and 19
                            years of experience, training competent professionals for the labour market and
                            self-employment since 2004.
                        </p>

                        <p>We offer short and medium-term professional courses to an average of 2000 young people and
                            adults in our delegate in the City of Maputo each year.</p>

                        <p>Furthermore, we design and implement projects that promote
                            entrepreneurship and recover livelihoods, as well as preparation programs for the labour
                            market for communities in urban and rural areas in partnership with various public and
                            private sector institutions.
                            .
                        </p>


                        <p>Within most of our programmes, our approach and process to ensure the quality of courses and
                            continuous improvement consists of surveying training needs, designing and adapting training
                            curricula, selecting qualified trainers, and training trainers, equipping and adapting
                            training sites, identifying and selecting target audiences, and training, evaluation, and
                            monitoring. </p>

                        <p>As per performance, we act as a nationwide strategic partner in the implementation of
                            training projects in many districts in Mozambique, including but not limited to Maputo,
                            Matola, Kamaxaquene, Manhiça, Matutuine, Moatize, Nacala-à-Velha, Nacala Porto, Nampula,
                            Cuamba, Monapo, Inhassoro, Govuro, Vilanculos, Manica, Sofala, and Palma-Afungi in various
                            training programmes for organizations such as Sasol, TotalEnergies, CNE, and Vulcan, amongst
                            others.</p>
                    ...
                    <div class="col-lg-6">
                        <div>
                            <h2>Mission</h2>
                            <p>
                                Train competent professionals for the labour market and self-employment.
                            </p>
                        </div>
                        <div>
                            <h2>Vision</h2>
                            <p>To became the largest training centre in the country. </p>
                        </div>

                        <div>
                            <h2>Values</h2>
                            <p>
                                Commitment, Excellence, Integrity, Trust, Flexibility and Innovation.
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="services" data-aos="fade-up" data-aos-delay="100">
                            <img src="assets/img/courses/1.jpg" alt="Short-term Vocational Programmes" loading="lazy"
                                class="img-fluid" />
                            <div class="details">
                                <h3>SHORT-TERM VOCATIONAL PROGRAMMES</h3>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="services" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="details">
                                <h3>TAILORED CORPORATE AND EXECUTIVE PROGRAMMES</h3>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="services" data-aos="fade-up" data-aos-delay="300">
                            <img src="assets/img/courses/3.jpg" alt="Youth Development Training Projects" loading="lazy"
                                class="img-fluid" />
                            <div class="details">
                                <h3>YOUTH DEVELOPMENT TRAINING PROJECTS </h3>
                                <br> <br>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="services" data-aos="fade-up" data-aos-delay="100">
                            <img src="assets/img/courses/2.jpg" alt="Rural Empowerment Training Projects" loading="lazy"
                                class="img-fluid" />
                            <div class="details">
                                <h3>RURAL EMPOWERMENT TRAINING PROJECTS </h3>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div role="tabpanel" class="col-lg-12 tab-pane fade show active" id="services-1">
                        <div class="container">
                            <div class="section-header">
                                <h2>LABOUR MARKET PREPARATION PROGRAMME</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="details">
                                        ...
                                        <p>
                                            In partnership with Vulcan Moçambique, 1,000 participants residing in the
                                            areas of interference direct or indirect from the Moatize mine were trained
                                            in various vocational training courses such as Industrial Maintenance
                                            Mechanics, Industrial Electricity, Welding, Heavy Machinery Operation, Hotel
                                            and Restaurant Management, Electricity Installation, Locksmithing, Auto
                                            Mechanics, Auto Electricity and Refrigeration.
                                        </p>

                                        <p>
                                            Implemented from September 2021 to October 2023, this programme aimed to
                                            encourage hiring local labour based on technical & behavioural training,
                                            mapping opportunities, and creating a database of professionals residing in
                                            the area mentioned above (s)
                                        </p>

                                        <p>At the end of the programme, we distributed 600 self-employment kits.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div role="tabpanel" class="col-lg-12 tab-pane fade" id="services-2">
                        <div class="container">
                            <div class="section-header">
                                <h2>
                                    WOMEN’S EMPOWERMENT: TRAINING PROGRAMME IN CUTTING AND SEWING
                                </h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="details">
                                        ...
                                        <p>We implemented one of our first projects in partnership with Vulcan
                                            Moçambique (formerly Vale Moçambique) in 2014. This project aimed to equip
                                            women in the district of Moatize with cutting and sewing skills, allowing
                                            them to make clothing and embroidery.
                                        </p>

                                        <p>In this programme, we trained 50 women who received work kits and created The
                                            Association of Seamstresses of Moatize, an operating initiative and
                                            Cooperative today.
                                        </p>
                    ...
                    <div role="tabpanel" class="col-lg-12 tab-pane fade" id="services-3">
                        <div class="container">
                            <div class="section-header">
                                <h2>ACREDITA EMPREGA (Government Programme) </h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="details">
                                        ...
                                        <p>
                                            Acredita Emprega, a programme funded by the World Bank in partnership with
                                            the Secretaria de Estado da Juventude e Emprego (SEJE) and other
                                            stakeholders, was implemented in the Southern provinces of Mozambique where
                                            we trained more than 1,500 young individuals from the districts of
                                            KaMaxaquene, Manhiça, Matola, and Matutuine.

                                        </p>

                                        <p>This recurring programme aims to improve youth access to education and
                                            employment opportunities. Courses offered included Entrepreneurship,
                                            Carpentry, Cooking, Cutting and Sewing, Refrigeration Systems, Auto
                                            Mechanics, Hardware and Plumbing.
                                        </p>
                    ...
                    <div role="tabpanel" class="col-lg-12 tab-pane fade" id="services-4">
                        <div class="container">
                            <div class="section-header">
                                <h2>
                                    EMPLOYMENT AND SKILLS FOR DEVELOPMENT (E4D) PROJECT
                                </h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="details">
                                        ...
                                        <p>
                                            Entrepreneur development program with two components, namely,
                                            Entrepreneurship Training and Business Coaching.

                                        </p>
                                        <p>In collaboration with GIZ, we successfully implemented this business project
                                            in Inhassoro and Govuro, training 500 individuals.
                                        </p>
                                        <p>The project aimed to support local economic development in the districts of
                                            Inhassoro and Govuro in the Inhambane Province by offering demand-driven
                                            skills programs and supporting SMEs to improve their overall capacity and,
                                            ultimately, rural development.
                                        </p>
                    ...
                    <div role="tabpanel" class="col-lg-12 tab-pane fade" id="services-5">
                        <div class="container">
                            <div class="section-header">
                                <h2>
                                    FINANCIAL MANAGEMENT TRAINING AND SMALL BUSINESS PROMOTION
                                </h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="details">
                                        <p>The Financial Management Training and Small Business Promotion program was
                                            implemented in Afungi, Palma, in the province of Cabo Delgado, in
                                            partnership with TotalEnergies. We trained more than 400 people in this
                                            program between 2019 and 2021.
                                        </p>

                                        <p>This programme aimed to provide resettled populations with financial
                                            management knowledge to manage their compensation(s) better.
                                        </p>

                                        <p>In addition, this programme launched and established Savings groups, where
                                            the following courses implemented included Business Coaching and Mentoring
                                            sessions.
                                        </p>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 mt-3 mt-md-0">
                                <input type="text" class="form-control" name="phone" id="phone"
                                    placeholder="Contact (Cellphone)" required />
                            </div>
                        </div>
    ...
    <footer id="footer">
                    ...
                    <div class="col-lg-3 col-md-6 footer-links">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="#programmes">Programmes & Projects</a>
                            </li>
                            <li>
                                <i class="bi bi-chevron-right"></i>
                                <a href="#supporters">Partners</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="container">
            <div class="copyright">
                &copy; All Rights Reserved. <strong></strong>Tecnicol Moçambique 2023
            </div>
            <div class="credits">
